 ...
 * globals.css.
 *
 * Sits at `-z-10`, so a parent needs `relative` and its content needs to be in
 * the normal flow (or higher) to stay above it.
 */
export function AmbientField() {
  return (
    ...
    >
      ...
      <div className="absolute -left-1/4 top-[-20%] h-[70vh] w-[70vh] animate-drift-a rounded-full bg-[radial-gradient(circle,rgba(255,208,40,0.05),transparent_70%)]" />
      <div className="absolute -right-1/4 bottom-[-25%] h-[80vh] w-[80vh] animate-drift-b rounded-full bg-[radial-gradient(circle,rgba(91,155,213,0.05),transparent_70%)]" />
      ...
      <svg
        ...
        strokeWidth="1"
      >
        <g className="animate-drift-a text-paper/[0.06]">
          <circle cx="180" cy="200" r="140" />
          <circle cx="180" cy="200" r="86" />
        </g>

        <g className="animate-drift-b text-paper/[0.05]">
        ...
        <g
          className="animate-spin-slow text-paper/[0.04]"
